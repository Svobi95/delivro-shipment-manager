  ...
  var li = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    Pa = li((e) => {
      ...
      function g(C) {
        ...
        for ($ = 0; $ < Y; $ += 4)
          ((S =
            (r[C.charCodeAt($)] << 18) | (r[C.charCodeAt($ + 1)] << 12) | (r[C.charCodeAt($ + 2)] << 6) | r[C.charCodeAt($ + 3)]),
            (k[q++] = (S >> 16) & 255),
            (k[q++] = (S >> 8) & 255),
            (k[q++] = S & 255));
        return (
...
var un,
  ...
  Oi = !0;
typeof y < "u" &&
  (({ FORCE_COLOR: un, NODE_DISABLE_COLORS: Ci, NO_COLOR: Si, TERM: Ri } = y.env || {}), (Oi = y.stdout && y.stdout.isTTY));
...
R.toExponential = function (e, t) {
  ...
  return (
    e === void 0
      ? (r = Ee(n, !0))
      : (ae(e, 0, Be), t === void 0 ? (t = i.rounding) : ae(t, 0, 8), (n = I(new i(n), e + 1, t)), (r = Ee(n, !0, e + 1))),
...
R.toSignificantDigits = R.toSD = function (e, t) {
  var r = this,
    n = r.constructor;
  return (
    e === void 0 ? ((e = n.precision), (t = n.rounding)) : (ae(e, 1, Be), t === void 0 ? (t = n.rounding) : ae(t, 0, 8)),
    I(new n(r), e, t)
  );
};
R.toString = function () {
...
function nu(e, t) {
  ...
  ((n = t.d.length),
    n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / Er(4, r)).toString())) : ((r = 16), (i = "2.3283064365386962890625e-10")),
    (e.precision += r),
...
function mr(e, t) {
  ...
  if (((t = t.slice(n, i)), t)) {
    ...
    for (; n--; ) t += "0";
    (e.d.push(+t),
      D && (e.e > e.constructor.maxE ? ((e.d = null), (e.e = NaN)) : e.e < e.constructor.minE && ((e.e = 0), (e.d = [0]))));
  } else ((e.e = 0), (e.d = [0]));
  return e;
}
function iu(e, t) {
...
function kn(e, t, r, n) {
  var i,
    ...
    O = e.constructor,
    C = r !== void 0;
  if ((C ? (ae(r, 1, Be), n === void 0 ? (n = O.rounding) : ae(n, 0, 8)) : ((r = O.precision), (n = O.rounding)), !e.isFinite()))
    g = co(e);
  else {
    for (
      g = Ee(e),
        ...
        s >= 0 && ((g = g.replace(".", "")), (T = new O(1)), (T.e = g.length - s), (T.d = fr(Ee(T), 10, i)), (T.e = T.d.length)),
        h = fr(g, 10, i),
        o = l = h.length;
      h[--l] == 0;
    )
    ...
    if (!h[0]) g = C ? "0p+0" : "0";
      ...
      if (
        (s < 0 ? o-- : ((e = new O(e)), (e.d = h), (e.e = o), (e = U(e, T, r, n, 0, i)), (h = e.d), (o = e.e), (u = ro)),
        (s = h[r]),
        (a = i / 2),
        (u = u || h[r + 1] !== void 0),
        (u =
      ...
      for (let S in r) {
        ...
        for (let _ = 0; _ < F.length; ++_) {
          ...
          for (let J = n, ie = i; J < t.length; ie += t[J].length, ++J) {
            ...
            if (
              (X.push(Ze), C && X.push(C), Array.prototype.splice.apply(t, X), u != 1 && N.matchGrammar(e, t, r, J, ie, !0, S), o)
            )
              break;
          }
        }
  ...
  Yr = class {
    ...
    handleAndLogRequestError(t) {
      try {
        ...
        throw (
          this.logEmitter && this.logEmitter.emit("error", { message: r.message, target: t.clientMethod, timestamp: new Date() }),
          r
        );
      }
    }
