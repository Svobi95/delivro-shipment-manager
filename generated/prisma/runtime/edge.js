  ...
  var gi = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    Ra = gi((e) => {
      ...
      function g(S) {
        ...
        for (J = 0; J < le; J += 4)
          ((C =
            (r[S.charCodeAt(J)] << 18) | (r[S.charCodeAt(J + 1)] << 12) | (r[S.charCodeAt(J + 2)] << 6) | r[S.charCodeAt(J + 3)]),
            (O[L++] = (C >> 16) & 255),
            (O[L++] = (C >> 8) & 255),
            (O[L++] = C & 255));
        return (
    ...
    function (e, t, r) {
      ...
      return (
        Number.isInteger(r) && Math.abs(r) > 2 ** 32
          ? (i = di(String(r)))
          : typeof r == "bigint" &&
            ((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = di(i)), (i += "n")),
...
var wn,
  ...
  Fi = !0;
typeof y < "u" &&
  (({ FORCE_COLOR: wn, NODE_DISABLE_COLORS: Mi, NO_COLOR: _i, TERM: Ni } = y.env || {}), (Fi = y.stdout && y.stdout.isTTY));
...
R.toSignificantDigits = R.toSD = function (e, t) {
  var r = this,
    n = r.constructor;
  return (
    e === void 0 ? ((e = n.precision), (t = n.rounding)) : (oe(e, 1, Me), t === void 0 ? (t = n.rounding) : oe(t, 0, 8)),
    k(new n(r), e, t)
  );
};
R.toString = function () {
  ...
  return (
    ...
    n == null
      ...
      : t < 4
        ...
        : (s =
            (((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == K(10, t - 3) - 1),
    s
  );
}
function br(e, t, r) {
...
function _n(e, t, r, n) {
  var i,
    ...
    I = e.constructor,
    S = r !== void 0;
  if ((S ? (oe(r, 1, Me), n === void 0 ? (n = I.rounding) : oe(n, 0, 8)) : ((r = I.precision), (n = I.rounding)), !e.isFinite()))
    g = bo(e);
  else {
    for (
      g = ye(e),
