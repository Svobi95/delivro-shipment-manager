  ...
  Yo = ye(() => {
    ...
    _e = (function () {
      ...
      return function (n, i, o, s) {
        ...
        if (
          (z[w] > (ve[w] || 0) && --f, o == null ? (ue = o = Wr.precision) : s ? (ue = o + (Z(n) - Z(i)) + 1) : (ue = o), ue < 0)
        )
          return new Wr(0);
...
var hi,
  ...
  is = !0;
typeof g < "u" &&
  (({ FORCE_COLOR: hi, NODE_DISABLE_COLORS: ts, NO_COLOR: rs, TERM: ns } = g.env || {}), (is = g.stdout && g.stdout.isTTY));
