  ...
  vn = ie(() => {
    ...
    S.toExponential = function (t, e) {
      ...
      return (
        t === void 0
          ? (r = ke(n, !0))
          : (ce(t, 0, Le), e === void 0 ? (e = i.rounding) : ce(e, 0, 8), (n = L(new i(n), t + 1, e)), (r = ke(n, !0, t + 1))),
        r
      );
    };
    ...
    S.toSignificantDigits = S.tosd = function (t, e) {
      var r = this,
        n = r.constructor;
      return (
        t === void 0 ? ((t = n.precision), (e = n.rounding)) : (ce(t, 1, Le), e === void 0 ? (e = n.rounding) : ce(e, 0, 8)),
        L(new n(r), t, e)
      );
    };
    S.toString =
    ...
    he = (function () {
      ...
      return function (n, i, o, s) {
        ...
        if ((B[h] > (le[h] || 0) && --f, o == null ? (z = o = Rt.precision) : s ? (z = o + (j(n) - j(i)) + 1) : (z = o), z < 0))
          return new Rt(0);
...
var Rr,
  ...
  kn = !0;
typeof g < "u" &&
  (({ FORCE_COLOR: Rr, NODE_DISABLE_COLORS: Rn, NO_COLOR: Sn, TERM: On } = g.env || {}), (kn = g.stdout && g.stdout.isTTY));
  ...
  br = class {
    ...
    handleAndLogRequestError(e) {
      try {
        ...
        throw (
          this.logEmitter && this.logEmitter.emit("error", { message: r.message, target: e.clientMethod, timestamp: new Date() }),
          r
        );
      }
    }
