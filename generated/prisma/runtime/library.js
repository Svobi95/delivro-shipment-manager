  ...
  function gp(e, r, t = {}) {
    ...
    for (let o of Object.keys(r))
      Object.prototype.hasOwnProperty.call(e, o)
        ? (i === !0 && (e[o] = r[o]),
          n &&
            ot(i === !0 ? `"${o}" is already defined and WAS overwritten` : `"${o}" is already defined and was NOT overwritten`))
        : (e[o] = r[o]);
  }
...
m.toSignificantDigits = m.toSD = function (e, r) {
  var t = this,
    n = t.constructor;
  return (
    e === void 0 ? ((e = n.precision), (r = n.rounding)) : (ne(e, 1, Ye), r === void 0 ? (r = n.rounding) : ne(r, 0, 8)),
    y(new n(t), e, r)
  );
};
m.toString = function () {
  ...
  return (
    ...
    n == null
      ...
      : r < 4
        ...
        : (s =
            (((n || t < 4) && a + 1 == o) || (!n && t > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == U(10, r - 3) - 1),
    s
  );
}
function fn(e, r, t) {
      ...
      for (let g in t) {
        ...
        for (let T = 0; T < I.length; ++T) {
          ...
          for (let j = n, te = i; j < r.length; te += r[j].length, ++j) {
            ...
            if (
              (K.push(fr), h && K.push(h), Array.prototype.splice.apply(r, K), u != 1 && v.matchGrammar(e, r, t, j, te, !0, g), o)
            )
              break;
          }
        }
...
`
    ...
    .map((r) =>
      r.replace(/^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)\s*/, "").replace(/\+\d+\s*ms$/, "")
    ).join(`
`);
}
var yl = O(Os());
  ...
  ei = class {
    ...
    handleAndLogRequestError(r) {
      try {
        ...
        throw (
          this.logEmitter && this.logEmitter.emit("error", { message: t.message, target: r.clientMethod, timestamp: new Date() }),
          t
        );
      }
    }
